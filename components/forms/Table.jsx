...
var Table=React.createClass({
    ...
    componentWillReceiveProps:function(pros){
      if(this.props["data-options"].op!==undefined&&this.props["data-options"].op!==null)
        this.setState({op:this.props["data-options"].op});
    },
    render:function(){
        {/*css style width*/}
